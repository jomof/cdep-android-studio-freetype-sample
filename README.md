...
This is an sample project for using Freetype (http://www.freetype.org) and SDL2 (https://www.libsdl.org/) together in an Android Gradle project using the [CDep](https://github.com/jomof/cdep) dependency management tool to download the Freetype and SDL2 packages rather than building them. 
